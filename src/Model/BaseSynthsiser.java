...
public abstract class BaseSynthsiser {
	 ...
	 * @param fragments List<String> that you want to add stuff too. If you don't
	 *                  have a List<String> already constructed "new
	 *                  ArrayList<String>()" works well.
	...
	/**
	 * Finds the last word in your String (before the index of 99) by searching for
	 * spaces and ending punctuation. Will preferably parse on punctuation to
	 * alleviate mid-sentence pausing
	 * 
	 * @param input The String you want to search through.
	 * @return The index of where the last word of the string ends before the index
	 *         of 99.
	 */
	...
	/**
	 * Checks if char is an ending character Ending punctuation for all languages
	 * according to Wikipedia (Except for Sanskrit non-unicode)
	 * 
	...
	/**
	 * This class is a callable. A callable is like a runnable except that it can
	 * return data and throw exceptions. Useful when using futures. Dramatically
