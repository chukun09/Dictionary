...
public final class GoogleTranslate { // Class marked as final since all methods are static
	...
	/**
	 * Converts the ISO-639 code into a friendly language code in the user's default
	 * language For example, if the language is English and the default locale is
	 * French, it will return "anglais" Useful for UI Strings
	 * 
	...
	/**
	 * Automatically translates text to a system's default language according to its
	 * locale Useful for creating international applications as you can translate UI
	 * strings
	 * 
	...
	/**
	 * Automatically detects language and translate to the targetLanguage. Allows
	 * Google to determine source language
	 * 
	 * @see GoogleTranslate#translate(String, String, String)
	 * @param targetLanguage The language you want to translate into in ISO-639
	 *                       format
	 ...
	 * 
	 * @param sourceLanguage The language you want to translate from in ISO-639
	 *                       format
	 * @param targetLanguage The language you want to translate into in ISO-639
	 *                       format
	 * @param text           The text you actually want to translate
	 ...
	 * @return The language parsed from the rawData or en-US (English-United States)
	 *         if Google cannot determine it.
	 */
	...
	/***************************
	 * Cryptography section ************************************************ Thank
	 * Dean1510 for the excellent code translation
	 **************************/

	// TODO Possibly refactor code as utility class

	/**
	 * This function generates the int array for translation acting as the seed for
	...
	/**
	 * An implementation of an unsigned right shift. Necessary since Java does not
	 * have unsigned ints.
	 * 
